...
que.dat1$Network = factor("B4") # Add a column called 'Network' with the network name
...
que.dat2$Network = factor("B4") # Add a column called 'Network' with the network name
...
que.dat3$Network = factor("B4") # Add a column called 'Network' with the network name
...
que.dat4$Network = factor("B4") # Add a column called 'Network' with the network name
...
plot(x, quedata, type = "o", xlim=rev(range(x)))
```
