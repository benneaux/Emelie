...
df <- data.frame(x1=x1_ping, x2=x2_ping, y=pingdata)



p3 <- ggplot(data=df, aes(x=x1, y=y1, group=1)) +
  geom_line(color="red") +
  geom_point()
p3 <- p3 + geom_line(aes(y=y1), colour="red")
p3 <- p3 + geom_line(aes(y=y2), colour="green")
p3
